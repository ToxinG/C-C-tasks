...
namespace Format {
    ...
    formatSpecifier getSpecifier2(string const &format) {
        if (format[formatIndex + 1] == 'd') {
            return d;
        }
        if (format[formatIndex + 1] == 'i') {
            return i;
        }
        if (format[formatIndex + 1] == 'u') {
            return u;
        }
        if (format[formatIndex + 1] == 'o') {
            return o;
        }
        if (format[formatIndex + 1] == 'x') {
            return x;
        }
        if (format[formatIndex + 1] == 'X') {
            return X;
        }
        if (format[formatIndex + 1] == 'f') {
            return f;
        }
        if (format[formatIndex + 1] == 'F') {
            return F;
        }
        if (format[formatIndex + 1] == 'e') {
            return e;
        }
        if (format[formatIndex + 1] == 'E') {
            return E;
        }
        if (format[formatIndex + 1] == 'g') {
            return g;
        }
        if (format[formatIndex + 1] == 'G') {
            return G;
        }
        if (format[formatIndex + 1] == 'a') {
            return a;
        }
        if (format[formatIndex + 1] == 'A') {
            return A;
        }
        if (format[formatIndex + 1] == 'c') {
            return c;
        }
        if (format[formatIndex + 1] == 's') {
            return s;
        }
        if (format[formatIndex + 1] == 'p') {
            return p;
        }
        if (format[formatIndex + 1] == 'n') {
            return n;
        }
        return none;
    }
    ...
    string toString(bool starMode, formatType prototype, string const &format) {
        ...
        while (true) { //prints symbols before next "%"
            ...
            if (format[formatIndex] == '%' && getSpecifier2(format) != none) {
